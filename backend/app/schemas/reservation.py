...
class ReservationUpdate(BaseModel):
    ...
    fk_sala: Optional[int] = Field(None, alias="salaId")
    fk_professor: Optional[int] = Field(None, alias="professorId")
    fk_disciplina: Optional[int] = Field(None, alias="disciplinaId")
    fk_curso: Optional[int] = Field(None, alias="cursoId")
    fk_periodo: Optional[int] = Field(None, alias="periodoId")
    
    tipo: Optional[str] = None
    dia_horario_inicio: Optional[datetime] = None
    dia_horario_saida: Optional[datetime] = None
    dia_semana: Optional[str] = Field(None, alias="diaSemana")
